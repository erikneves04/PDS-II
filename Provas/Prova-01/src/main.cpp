...
int main() 
{
    ...
    ana->adicionar_saldo(30);
    pedro->adicionar_saldo(30);
    ...
    Carro * ca = sistema_uber.busca_uber("ana@dcc");
    std::cout << "Carro de placa " << ca->get_id();
    std::cout << " está ocupado? " << ca->ocupado() << std::endl;
