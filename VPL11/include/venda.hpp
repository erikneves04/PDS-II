...
/**
 * @brief Classe responsavel pelo gerenciamento de estoque e vendas de celulares.
 */
class Venda
{
    public:
        ...
        /**
         * @brief Adiciona um novo lote de celulares ao estoque atual de um determinado modelo.
        ...
        /**
         * @brief Processa a venda de um determinado modelo. A quantidade de celulares vendidos deve ser subtraida do estoque atual.
         * @param cod Codigo do celular.
        ...
        /**
         * @brief Aplica um desconto em todos os celulares de um fabricante. Ex: Desconto de 10% em todos os celulares Samsung.
        ...
        /**
         * @brief Imprime a lista de modelos de celulares que possuem pelo menos uma unidade em estoque.
         */
